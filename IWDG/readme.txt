...
2, the use of
   ...
   (5) HEX file is downloaded to the board, LED lights and port PB6 PB8 PC10 PC12 enable cycle to move a stepper motors only one step at a time,using HyperTerminal or serial debugging assistant can see the debugging information indicates that routine run correctly.
